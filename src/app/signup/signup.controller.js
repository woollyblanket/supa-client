(function(){
	...
	angular.module('supa') // make sure this is set to whatever it is in your client/scripts/app.js
	  .controller('SignupCtrl', SignupCtrl);

	function SignupCtrl($scope, $http, $log) { // note the added $http depedency
	    ...
	    signup.submit = function () {
	      ...
	      if (
	        ...
	        $log.debug('Please fill out all form fields.');
	      return false;
	    }

	      // make sure the passwords match match
	      if (user.password1 !== user.password2) {
	        $log.debug('Your passwords must match.');
	        return false;
	      }
